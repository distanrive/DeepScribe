...
const NAV_W := 196.0            # 导航侧边栏宽度
const NAV_PAD := 12.0           # 侧边栏内边距（SidebarPanel 的 content margin）
const PAD_NAV_H := 12.0         # 导航项左右内边距
const PAD_NAV_V := 9.0          # 导航项上下内边距
const NAV_SEP := 6            # 导航项之间的间距（theme constant，int）
